...
public:
	SphericalPointLight(ShaderProgram* _shader, Textures* texs, glm::vec3 _lightPos,
		...
		block = new Sphere(_lightPos, _blockSize, texs->get("textures/wood2.jpg"), _blockShader);
	}
};